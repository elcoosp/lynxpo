...
/**
 * Demonstrates Expo's `expo-video` full native method surface: every getter is
 ...
 */
export function useVideoInfo(): ModuleInfo {
  ...
  actions.push({ label: 'Mute', onPress: actMute });
