...
//         // OnDestroy { connectivityManager.unregisterNetworkCallback(networkCallback) }
//     }
...
//     @LynxMethod
//     fun getIpAddressAsync(callback: Callback) {
//         return callback.invoke(LynxUIMethodConstants.SUCCESS, rawIpToString(wifiInfo.ipAddress))
//     }

//     @LynxMethod
//     fun isAirplaneModeEnabledAsync(callback: Callback) {
...
//                         netCapabilities.hasTransport(NetworkCapabilities.TRANSPORT_WIFI_AWARE) ->
//                         NetworkStateType.WIFI
//                 netCapabilities.hasTransport(NetworkCapabilities.TRANSPORT_BLUETOOTH) ->
//                         NetworkStateType.BLUETOOTH
