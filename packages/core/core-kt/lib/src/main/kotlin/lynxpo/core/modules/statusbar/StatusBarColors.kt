...
import lynxpo.core.modules.statusbar.StatusBarColors.getDefaultStatusBarHeight
import lynxpo.core.modules.statusbar.StatusBarColors.transparencyChangeListener
...
object StatusBarColors {
    ...
    internal fun setTranslucentView(
        viewGroup: ViewGroup,
        @ColorInt color: Int,
    ...
    internal fun setRootView(activity: Activity, fitSystemWindows: Boolean) {
        ...
        while (i < count) {
            ...
            childView.let {
                if (it is ViewGroup) {
                    it.fitsSystemWindows = fitSystemWindows
