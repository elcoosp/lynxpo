...
- (id)getOrientationAsync {
  ...
  @try { return @([self getOrientation]); } @catch (NSException *e) { return nil; }
}
- (id)getOrientationLockAsync {

  @try { return @([self getOrientationLock]); } @catch (NSException *e) { return nil; }
}
- (id)lockAsync:(double)orientation {
  @try { [self lock:orientation]; return nil; } @catch (NSException *e) { return nil; }
}
- (id)unlockAsync {

  @try { [self lock:0]; return nil; } @catch (NSException *e) { return nil; }
}
- (id)lockPlatformAsync:(double)orientation {
  @try { [self lockPlatform:(NSInteger)orientation]; return nil; } @catch (NSException *e) { return nil; }
}
- (id)supportsOrientationLockAsync {
  @try { return @([self supportsOrientationLock]); } @catch (NSException *e) { return nil; }
}
